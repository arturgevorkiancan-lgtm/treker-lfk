...
exercises = {
    "warm_up": [
        {"name": "Ретракция подбородка", "file": "retraction_chin.jpg", "video_ids": ["H0TWk06p5s4"], "sets": "10×5 сек", "desc": "Подбородок слегка втягиваем назад."},
        {"name": "Мягкий наклон головы", "file": "head_tilt.jpg", "video_ids": ["YzUTTpqeQ0g"], "sets": "8–10 в каждую сторону", "desc": "Медленно, без рывков."},
        {"name": "Плечевые круги назад", "file": "shoulder_circles.jpg", "video_ids": ["lzR7tzI1JUI"], "sets": "10 раз", "desc": "Раскрываем грудной отдел."},
        {"name": "Тазовые наклоны у стены", "file": "pelvic_tilt_standing.jpg", "video_ids": ["O6R5YRRxwy0"], "sets": "10 раз", "desc": "Поясница прижимается к стене."}
    ],
    "lfk_core": [
        {"name": "Dead Bug (Мёртвый жук)", "file": "dead_bug.jpg", "video_ids": ["HrxOWhPdsOY"], "sets": "3×8–10 на сторону", "desc": "Поясница прижата к полу. Главное упражнение при протрузии L5-S1."},
        {"name": "Тазовый наклон лёжа", "file": "pelvic_tilt_lying.jpg", "video_ids": ["JyEPzCm8WNw"], "sets": "3×12–15", "desc": "Прижимаем поясницу к полу."},
        {"name": "Ягодичный мостик с подушкой", "file": "glute_bridge_pillow.jpg", "video_ids": ["tqp5XQPpTxY"], "sets": "3×12–15", "desc": "Под колени — подушка, сильно сжимаем ягодицы."}
    ],
    "lfk_hips": [
        {"name": "Clamshell (Ракушка)", "file": "clamshell.jpg", "video_ids": ["KibnWq-HwBM"], "sets": "3×12–15 на сторону", "desc": "Стопы вместе, поднимаем верхнее колено."}
    ],
    "lfk_thoracic": [
        {"name": "Открытие грудной клетки", "file": "thoracic_opening.jpg", "video_ids": ["SQF-0s1CckA"], "sets": "3×45–60 сек", "desc": "На валике вдоль позвоночника."},
        {"name": "Superman", "file": "superman.jpg", "video_ids": [], "sets": "3×10–12", "desc": "Лёжа на животе."},
        {"name": "Bird-Dog", "file": "bird_dog.jpg", "video_ids": ["X0FpQEjEA40"], "sets": "3×8–10 на сторону", "desc": "Противоположные рука и нога."}
    ],
    "feet": [
        {"name": "Короткая стопа", "file": "short_foot.jpg", "video_ids": ["DoEIW4Y8MEo", "D9qjQWqVIlI"], "sets": "3×12–15", "desc": "Подтягиваем свод стопы."},
        {"name": "Подъём на носки с разведением коленей", "file": "calf_raise_knees_out.jpg", "video_ids": ["oHbxRumbb6g"], "sets": "3×15", "desc": "Колени наружу."},
        {"name": "Ходьба по массажному коврику", "file": "foot_massage_mat.jpg", "video_ids": [], "sets": "5–7 минут", "desc": "По гальке или коврику."}
    ]
}
...
with tab1:
    ...
    for ex in exercises["warm_up"]:
        ...
        st.write(ex['desc'])
        for vid in ex.get("video_ids", []):
            st.video(f"https://www.youtube.com/embed/{vid}")
        st.divider()
